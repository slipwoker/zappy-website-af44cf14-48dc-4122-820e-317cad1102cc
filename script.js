document.addEventListener('DOMContentLoaded', function () {
  ...
  function applyFadeInStyles() {
    if (document.getElementById('fade-in-base-styles')) return;

    const style = document.createElement('style');
    style.id = 'fade-in-base-styles';
    style.textContent = [
      '.fade-in-element {',
      '  opacity: 0;',
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: 'af44cf14-48dc-4122-820e-317cad1102cc',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || 'af44cf14-48dc-4122-820e-317cad1102cc';
...
/* ZAPPY_CUSTOM_JS_START:0efff875a907 */
(function () {
  function __zappyCustomInit() {
    try {
// Project filter functionality for projects-section
(function() {
  ...
  function filterProjects(category) {
    ...
    cards.forEach(function(card, index) {
      ...
      const catList = cardCategories.split(',').map(function(c) { return c.trim(); });
  ...
  // Set initial transition styles on cards
...
/* ZAPPY_CUSTOM_JS_END:0efff875a907 */
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = 'af44cf14-48dc-4122-820e-317cad1102cc';
